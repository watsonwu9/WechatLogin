...
-(void)sendDataToJSWithUserInfoDictionary:(NSDictionary *)UserInfoDictionary {
  
  NSLog(@"you are in sendDataToJS");
  [_bridge.eventDispatcher sendDeviceEventWithName:@"UserInfo" body:UserInfoDictionary];
...
-(void) onResp:(BaseResp*)resp
{
  ...
  }else if (resp.errCode ==0)
  {
    ...
    //[self sendDataToJSWithRespCode:aresp.code];
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (data) {
        ...
        if ([dic objectForKey:@"errcode"]) {
          ...
          [_bridge.eventDispatcher sendDeviceEventWithName:@"UserInfo" body:@{@"userId":[dic objectForKey:@"openid"],@"token":[dic objectForKey:@"access_token"]}];
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      if (data) {
         ...
         */
          ...
          [self sendDataToJSWithUserInfoDictionary:dic];
